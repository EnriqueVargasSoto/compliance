...
export default defineConfig({
  ...
  // ℹ️ This plugin should be placed before vue plugin
    ...
    Components({
      dirs: ['resources/js/@core/components', 'resources/js/views/demos', 'resources/js/components', 'resources/js/views/roles-permisos/permisos/components', 'resources/js/views/modulos/components', 'resources/js/views/components'],
      dts: true,
      resolvers: [
        componentName => {
